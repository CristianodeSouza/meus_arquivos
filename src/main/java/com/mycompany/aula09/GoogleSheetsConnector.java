    ...
    private static Credential getCredentials(String credentialsFilePath) throws Exception {
        ...
        if (!credFile.exists()) {
            throw new IllegalArgumentException(
                "Arquivo de credenciais não encontrado: " + credentialsFilePath + "\n" +
                "Para usar o Google Sheets MCP, você precisa:\n" +
                "1. Acessar https://console.cloud.google.com/\n" +
                "2. Criar um novo projeto e ativar a Google Sheets API\n" +
                "3. Criar credenciais do tipo 'OAuth 2.0 Client ID' (Desktop Application)\n" +
                "4. Baixar o arquivo JSON e salvá-lo como '" + credentialsFilePath + "' na raiz do projeto"
            );
        }
